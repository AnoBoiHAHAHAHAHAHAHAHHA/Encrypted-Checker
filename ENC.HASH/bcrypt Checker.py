...
//   |  __|                           | |         | |      / ____| |             | |                          |  __ \         
//   | __ |  _ __   ___ _ __ _   _ _ __ | |_ ___  __| |     | |    | |__   ___  ___| | __     _ __ ___   ___    | |__) | __ ___ 
//   |  __| | '_ \ / __| '__| | | | '_ \| __/ _ \/ _` |     | |    | '_ \ / _ \/ __| |/ /    | '_ ` _ \ / _ \   |  ___/ '__/ _ \
//   | ___| | | | (__| |  | |_| | |_) | ||  __/ (_| |     | |____| | | |  __/ (__|   <     | | | | | | (_) |  | |   | | |  __/
//   |____|_|_| |_|\___|_|   \__, | .__/ \__\___|\__,_|     \_____|_| |_|\___|\___|_|\_\ |  | |_| |_|\___/ |_   |   |_|  \___|
//                            __/ | |                                             ______           ______              
//                           |___/|_|                                            |______|         |______|             
   # //                                            \$$$$$$  \$$
                                                                                              
   #                                                    #https://github.com/AnoBoiHAHAHAHAHAHAHAHHA    
   #                                                    #The_Malware_Gang_88
   ##############################################################################################################################################################################
...
def WhirlpoolHMAC(hash):
    ...
    if len(hash)==len(hs)and hash.isdigit()==False and hash.isaalpha()==False and hash.isalnum()==True:
        jerar.append('122080')
...
while True:
    try:
        ...
        if first:
            ...
            h = input("LAGAY MO YUNG HASH PRE: ")
